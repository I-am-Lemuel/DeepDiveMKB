 <div id="snapEnd" class="bg-gray-900 py-3 px-1 flex justify-center">
             ...
             <div class="my-6 text-base text-color f-f-l">
                 <ul class="md:flex items-center">
                     <li class="md:mr-6 cursor-pointer text-2xl pt-4 lg:py-0"><a
                             href="https://www.notion.so/30b1b2f93e4f490f81d6f290128b0e50?v=43c0792c119d412c91966f87c1ae0b8e"
                             class="focus:outline-none dark:text-white  focus:underline hover:text-gray-500">Notion</a>
                     </li>
                     <li class="md:mr-6 cursor-pointer text-2xl pt-4 lg:py-0"><a

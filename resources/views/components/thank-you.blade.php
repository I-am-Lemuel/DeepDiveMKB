...
<div class="flex items-center justify-center h-screen">
      <div class="p-1 rounded shadow-lg bg-gradient-to-r from-purple-500 via-green-500 to-blue-500">
        <div class="flex flex-col items-center p-6 space-y-3 bg-black">
          ...
          <p>Thank you for the information. Youre information will be checked.</p>
          <a href="/"
            ...
            <span class="text-sm font-medium" href>
              Home
            </span>
          </a>
        </div>
